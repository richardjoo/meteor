...
_.extend(Meteor._Stream, {
  ...
  _toSockjsUrl: function(url) {
    ...
    if (startsWith(url, 'ddp+sockjs://')) {
      // Remove scheme and split off the host.
      var urlAfterDDP = url.substr('ddp+sockjs://'.length);
      ...
      // ddp+sockjs is always tunneled over HTTPS. (Maybe define ddpi+sockjs to
      // tunnel over HTTP? Secure should be the default.)
